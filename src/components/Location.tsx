...
const locationDetails = [
  {
    ...
    description: "Centrally located to serve students and tourists"
  },
  {
    icon: Route,
    title: "Connected Zones",
    description: "Connects Area 2 (Student Accommodation) and Area 3 (Adventure Zone)"
  },
  {
    icon: TreePine,
    title: "Educational Hub",
    description: "Offers workshops, classrooms, and outdoor learning spaces"
  }
];
