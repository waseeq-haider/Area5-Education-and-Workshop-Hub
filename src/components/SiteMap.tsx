...
export const SiteMap = () => {
  const [selectedArea, setSelectedArea] = useState<Area | null>(areas[4]); // Area 5 default
                        ...
                        area.connections.map(connId => {
                          ...
                          return (
                            <path
                              ...
                              fill="none"
                              strokeDasharray={area.id === 5 || connId === 5 ? "2,2" : "none"}
